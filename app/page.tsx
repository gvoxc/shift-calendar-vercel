        ...
        >
          ...
          <Card className="rounded-3xl border-0 shadow-sm">
            ...
            <CardContent className="p-3 sm:p-6">
              <div className="grid grid-cols-7 gap-1 sm:gap-2 text-center text-xs sm:text-sm font-medium text-slate-500">
                {["日", "一", "二", "三", "四", "五", "六"].map((w) => (
                ...
                {monthDays.map((date) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileHover={{ y: -2 }}
                      className={[
                        "min-h-[72px] sm:min-h-[108px] rounded-xl sm:rounded-2xl border p-1.5 sm:p-3 text-left shadow-sm transition",
                        isCurrentMonth
                    ...
                    >
                      <div className="flex items-start justify-between gap-1">
                        <div className="text-xs sm:text-sm font-semibold">{date.getDate()}</div>
                        {isToday && (
                          <span className="rounded-full bg-slate-900 px-1 sm:px-2 py-0.5 text-[10px] sm:text-xs text-white leading-tight">
                            今天
                          </span>
                        )}
                      </div>
                      ...
                      <div className="mt-1.5 sm:mt-4">
                        <span
                          className={`inline-flex items-center gap-1 sm:gap-2 rounded-full border px-1.5 sm:px-2.5 py-0.5 sm:py-1 text-[10px] sm:text-xs ${meta.badge}`}
                        >
